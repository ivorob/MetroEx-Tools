...
int APIENTRY wWinMain(
    ...
    WNDCLASSEX wc = { sizeof(WNDCLASSEX), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL,
        _T("Metro Exodus Explorer"), NULL };
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindow(wc.lpszClassName, _T("Metro Exodus Explorer"), WS_OVERLAPPEDWINDOW, 100, 100, 1280, 800,
    ...
    gEditor.SetMainWnd(hwnd);
    switchTool(Tool::MainMenu);
